...
mod test {
    ...
    fn test_generate_template_name() {
        ...
        assert_eq!(
            generate_template_name("components", "user-profile"),
            "UserProfile"
        );

        // Test services
        assert_eq!(
            generate_template_name("services", "cat-list"),
            "CatListService"
        );
        assert_eq!(
            generate_template_name("services", "user-auth"),
            "UserAuthService"
        );
    ...
    fn test_generate_template_name_edge_cases() {
        ...
        assert_eq!(
            generate_template_name("Services", "api-client"),
            "ApiClientService"
        );
        assert_eq!(generate_template_name("TYPES", "user-data"), "UserDataType");
        ...
        // Unknown item types
        assert_eq!(
            generate_template_name("unknown", "user-profile"),
            "UserProfile"
        );
        assert_eq!(
            generate_template_name("custom-type", "api-client"),
            "ApiClient"
        );

        // Complex names
        assert_eq!(
            generate_template_name("services", "complex_API-client_name"),
            "ComplexAPIClientNameService"
        );
        assert_eq!(
            generate_template_name("types", "XMLHttpRequest"),
            "XMLHttpRequestType"
        );
    ...
    fn test_unicode_handling() {
        ...
        assert_eq!(
            generate_template_name("components", "página-usuário"),
            "PáginaUsuário"
        );
    }
